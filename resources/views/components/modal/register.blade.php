        ...
        <form action="index.php" method="get">
            ...
            <div class="relative flex-auto p-6 mx-10">
                <div class="mb-4">
                    ...
                    <input class="w-full px-4 py-3 text-xs border border-gray-300 rounded-lg appearance-none placeholder-serv-text" id="username" type="text" placeholder="Your name">
                </div>
                <div class="mb-4">
                    <label class="block mb-2 text-sm text-grey-darker" for="email">
                        Email
                    </label>
                    <input class="w-full px-4 py-3 text-xs border border-gray-300 rounded-lg appearance-none placeholder-serv-text" id="email" type="email" placeholder="name@domain.com">
                </div>
                <div>
                    <label class="block mb-2 text-sm text-grey-darker" for="password">
                        Password
                    </label>
                    <input class="w-full px-4 py-3 mb-3 text-xs border border-gray-300 rounded-lg appearance-none placeholder-serv-text" id="password" type="password" placeholder="At least 8 characters">
                </div>
            ...
            <div class="px-6 pb-6 mx-10 rounded-b-xl">
                ...
                <a href="#" class="block w-full px-12 py-3 my-2 text-lg text-center text-white rounded-lg bg-serv-button" onclick="toggleModal('registerSuccessModal');toggleModal('registerModal')">
                    Sign up
                </a>
